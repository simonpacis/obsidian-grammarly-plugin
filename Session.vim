...
silent only
silent tabonly
cd ~/Documents/Development/Temps/TempVault/TempVault/.obsidian/plugins/obsidian-grammarly-plugin
...
wincmd w
argglobal
if bufexists("plugin.ts") | buffer plugin.ts | else | edit plugin.ts | endif
balt styles.css
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
silent! normal! zE
let &fdl = &fdl
let s:l = 47 - ((43 * winheight(0) + 28) / 57)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 47
